...
import 'package:shubhithasenergysolutions_admin/scr/features/core/screens/totalQuotations/widget/totalQuoteListWidget.dart';

class totalQuotationsScreen extends StatefulWidget {
  const totalQuotationsScreen({super.key});

  @override
  State<totalQuotationsScreen> createState() => _totalQuotationsScreenState();
}

class _totalQuotationsScreenState extends State<totalQuotationsScreen> {
