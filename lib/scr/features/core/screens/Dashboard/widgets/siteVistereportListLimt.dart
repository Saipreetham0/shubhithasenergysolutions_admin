...
class SiteVistReportsListLimit extends StatelessWidget {
  List<DataRow> rows = [];
  @override
          ...
          builder: (_, AsyncSnapshot<QuerySnapshot> snapshot) {
            ...
            rows = users
                .map((user) => DataRow(cells: [
                      ...
                      DataCell(Text(user['NameOfSiteBuilding'])),
                      DataCell(
                        ConstrainedBox(
                          constraints: const BoxConstraints(maxWidth: 250),
                          child: Text(user['LiveLocationLat'] +
                              '  ' +
